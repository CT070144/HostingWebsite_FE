        ...
        <div className={cx('modalOverlay')} onClick={() => setIsModalOpen(false)}>
          <div className={cx('modalContent', 'productModal')} onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit} className={cx('productForm')}>
              ...
              <div className={cx('formGroup')} style={{ marginTop: '20px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
                  <label className={cx('formLabel')} style={{ marginBottom: 0, fontSize: '16px', fontWeight: 600 }}>
      ...
      {isDiscountModalOpen && (
        <div className={cx('modalOverlay')} onClick={handleCloseDiscountModal}>
          ...
          >
            ...
            <div style={{ padding: '20px' }}>
              ...
              <div style={{ marginBottom: '30px', padding: '20px', backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                  <div className={cx('formGroup')}>
                    <label className={cx('formLabel')}>Mã code *</label>
                    <input
                      type="text"
                  ...
                  <div className={cx('formGroup')}>
                    <label className={cx('formLabel')}>% Giảm giá *</label>
                    <input
                      type="number"
                  ...
                  <div className={cx('formGroup')}>
                    <label className={cx('formLabel')}>Chu kỳ tối đa (tháng)</label>
                    <input
                      type="number"
              ...
              <div>
                ...
                <div className={cx('formGroup')} style={{ marginBottom: '15px' }}>
                  <input
                    type="text"
            ...
            <div className={cx('modalHeader')} style={{ padding: '15px 20px', borderTop: '1px solid #e0e0e0', justifyContent: 'flex-end', borderBottom: 'none' }}>
              <button
                type="button"
                className={cx('btn', 'btnSecondary')}
            ...
            <div style={{ padding: '16px' }}>
                  ...
                  featuredProducts.map((item) => (
                    ...
                    >
                      ...
                      <div style={{ display: 'flex', gap: '8px' }}>
                        <button className={cx('btn', 'btnSecondary')} onClick={() => handleEditFeatured(item)}>
                          <i className="fas fa-edit"></i>
                        </button>
                        <button className={cx('btnIcon', 'btnDelete')} onClick={() => handleDeleteFeatured(item.id)}>
                          <i className="fas fa-trash"></i>
                        </button>
                      </div>
                    </div>
              ...
              <form onSubmit={handleSubmitFeatured}>
                <div className={cx('formRow')}>
                  <div className={cx('formColumn')}>
                    <div className={cx('formGroup')}>
                      <label className={cx('formLabel')}>Tiêu đề *</label>
                      <input
                        type="text"
                    ...
                    <div className={cx('formGroup')}>
                      <label className={cx('formLabel')}>Icon</label>
                  ...
                  <div className={cx('formColumn')}>
                    <div className={cx('formGroup')}>
                      <label className={cx('formLabel')}>Giá *</label>
                      <input
                        type="text"
                    ...
                    <div className={cx('formGroup')}>
                      <label className={cx('formLabel')}>Đơn vị giá</label>
                      <input
                        type="text"
                    ...
                    <div className={cx('formGroup')}>
                      <label className={cx('formLabel')}>Liên kết</label>
                      <input
                        type="text"
                ...
                <div className={cx('formActions')}>
                  <button type="button" className={cx('btn', 'btnSecondary')} onClick={handleCloseFeaturedModal}>
                    Hủy
                  </button>
                  <button type="button" className={cx('btn', 'btnSecondary')} onClick={handleOpenFeaturedPreview}>
                    Xem trước
                  </button>
                  <button type="submit" className={cx('btn', 'btnPrimary')}>
            ...
            <div style={{ padding: '16px' }}>
                ...
                {loadingAddons ? (
                  ...
                  addons.map((addon) => (
                    ...
                    >
                      ...
                      <div style={{ display: 'flex', gap: '8px' }}>
                        <button className={cx('btn', 'btnSecondary')} onClick={() => handleEditAddon(addon)}>
                          <i className="fas fa-edit"></i>
                        </button>
                        <button className={cx('btnIcon', 'btnDelete')} onClick={() => handleDeleteAddon(addon.addon_id)}>
                          <i className="fas fa-trash"></i>
                        </button>
                      </div>
                    </div>
              ...
              <form onSubmit={handleSubmitAddon}>
                <div className={cx('formRow')}>
                  <div className={cx('formColumn')}>
                    <div className={cx('formGroup')}>
                      <label className={cx('formLabel')}>Tên addon *</label>
                      <input
                        type="text"
                    ...
                    <div className={cx('formGroup')}>
                      <label className={cx('formLabel')}>Loại addon *</label>
                      <input
                        type="text"
                  ...
                  <div className={cx('formColumn')}>
                    <div className={cx('formGroup')}>
                      <label className={cx('formLabel')}>Giá mỗi đơn vị (VNĐ) *</label>
                      <input
                        type="number"
                    ...
                    <div className={cx('formGroup')}>
                      <label className={cx('formLabel')}>Số lượng tối thiểu *</label>
                      <input
                        type="number"
                    ...
                    <div className={cx('formGroup')}>
                      <label className={cx('formLabel')}>Số lượng tối đa (tùy chọn)</label>
                      <input
                        type="number"
                ...
                <div className={cx('formActions')}>
                  <button type="button" className={cx('btn', 'btnSecondary')} onClick={handleCloseAddonModal}>
                    Hủy
                  </button>
                  <button type="submit" className={cx('btn', 'btnPrimary')}>
